...
def search(request):
    if request.GET:
        ...
        search_result = ContactList.objects.filter(
            ...
            Q(cinfo__icontains=search_query)
        )
        context = {
...
class CreateContact(LoginRequiredMixin,CreateView):
    ...
    model = ContactList
    fields = ['name','email','phone','gender','cinfo','cimg']
    def form_valid(self,form):
        instance = form.save(commit=False)
        instance.manager=self.request.user
        instance.save()
        messages.success(self.request,'Successfully create your contact.')
...
class ContactUpdate(LoginRequiredMixin,UpdateView):
    ...
    def form_valid(self,form):
        instance = form.save()
        messages.success(self.request,'Successfully updated your contacts')
...
class ContactDelete(LoginRequiredMixin,DeleteView):
    ...
    def delete(self,request,*args,**kwargs):
        messages.success(self.request,'Successfully Deleted your contacts')
